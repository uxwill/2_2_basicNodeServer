...
function setup() {
  ...
  weatherName = createElement('h2', 'its sunny and cloudy');
  weatherName.position(0, 100);

  textAlign(CENTER)
  textSize(50);

  sun1 = createSprite(200,20);
  sun1.addAnimation("normal","assets/sun/sun1.png","assets/sun/sun2.png");
  // cloud.velocity.x = 3;

  cloud = createSprite(random(0,width),random(0,200));
  ...
  asterisk.addAnimation("normal", "assets/sunMan/sunMan1.png","assets/sunMan/sunMan2.png");
  
  asterisk.addAnimation("rainedOn", "assets/sunnedOn/sunnedOn1.png","assets/sunnedOn/sunnedOn2.png");
  ...
  for(var i=0; i<40; i++)
    ...
    box.addAnimation("normal", "assets/sunShine/sunShine1.png","assets/sunShine/sunShine2.png");
    box.velocity.y = 1;
    obstacles.add(box);
    } 
